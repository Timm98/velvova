 ...
 * Bewerbung waren.
 *
 * Nicht hier: der Nina-Chat, die Lebenshaltung, das aktuelle Gehalt, die
  ...
  return (
    <div className="grid gap-8">
      <div className="grid gap-2">
        <h1 className="font-display text-2xl font-semibold tracking-[-0.02em]">Bewerbungen</h1>
        <p className="max-w-[var(--measure)] text-sm leading-relaxed text-ink-2">
          Was du hier siehst, hat die Person für diese eine Stelle freigegeben. Ihr Karrieregespräch
          mit Nina, ihre Lebenshaltung und ihr aktuelles Gehalt sind für uns nicht abrufbar — auch
          nicht auf Anfrage.
        </p>
      </div>
