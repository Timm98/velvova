...
/**
 * Mondays Hinweis auf eine Fähigkeit, die sie hier hätte.
 *
 ...
 *
 *   - Was Monday zusätzlich tun könnte, in einem Satz.
 ...
 * darüber. Monday beantwortet die Frage zuerst und weist danach hin, nie
...
export function PremiumHinweis({
  ...
  return (
    <aside className="grid gap-2 rounded-(--radius-lg) bg-soft px-5 py-4">
      {/*
        Mondays Formulierung, nicht die des Marketings: sie bietet an, was
