...
export const de = {
  ...
  consent: {
    ...
    externalAiBodyInactive:
      "Zurzeit ist kein KI-Anbieter eingerichtet. {assistant} antwortet dann nicht — " +
  ...
  jobs: {
    title: "{assistant}s Auswahl für dich",
  ...
  settings: {
    ...
    aiProviderNone:
      ...
      "und {assistant} antwortet auch nicht.",
    aiProviderExternal:
