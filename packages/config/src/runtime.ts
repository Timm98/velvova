 ...
 * Konfigurationsfehler sofort und verstaendlich auffaellt statt spaeter
 * als undefinierter Wert mitten in einem Request.
 *
 * Grundsatz: Ohne einen einzigen Schluessel muss das Projekt starten.
 * Fehlt ein Zugang, faellt der jeweilige Adapter auf einen deutlich
 * gekennzeichneten Demo-Pfad zurueck - er taeuscht nie Betrieb vor.
 */
 ...
 * Diese Funktion ist die Grundlage dafuer, dass die Oberflaeche ehrlich
