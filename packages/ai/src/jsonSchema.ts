...
/**
 * Zod-Schema in JSON Schema übersetzen, damit ein Anbieter mit Tool Use
 * daran gebunden werden kann. Zod 4 bringt das mit; die Hülle hier hält
 * die Abhängigkeit an einer Stelle und ergänzt, was Tool-Use-Schnittstellen
 * zusätzlich erwarten.
 */
