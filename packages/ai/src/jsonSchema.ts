 ...
 * daran gebunden werden kann. Zod 4 bringt das mit; die Huelle hier haelt
 * die Abhaengigkeit an einer Stelle und ergaenzt, was Tool-Use-Schnittstellen
 * zusaetzlich erwarten.
 */
