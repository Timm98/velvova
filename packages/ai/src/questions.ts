 ...
 * nicht nach Selbsteinschaetzung. "Bist du gut im Organisieren?" liefert
 * eine Meinung; "Erzaehl von etwas, das du organisiert hast" liefert
 * etwas, das man belegen und in eine Bewerbung schreiben kann.
 *
 * Jede Frage traegt einen stabilen Schluessel. Der Text darf sich aendern,
 * der Schluessel nicht - sonst brechen Auswertung und Verlauf.
 */
...
export const QUESTIONS: Question[] = [
  ...
  { key: "goal_change", stage: "consent_and_goal", yields: ["motive", "preference"],
    de: "Was soll sich durch deine naechste berufliche Entscheidung konkret veraendern?",
    en: "What should concretely change through your next career decision?",
    followUpDe: "Und woran wuerdest du merken, dass es sich veraendert hat?",
  ...
  { key: "search_status", stage: "current_situation", yields: ["preference"],
    de: "Wie laeuft deine Suche bisher? Wie viele Bewerbungen hast du ungefaehr geschrieben, und was kam zurueck?",
  ...
  { key: "lost_track_of_time", stage: "experience_episodes", yields: ["experience_episode", "action", "preference"],
    de: "Erzaehl von einer Aufgabe, bei der du die Zeit vergessen hast. Was hast du dabei tatsaechlich getan?",
    ...
    noExperienceVariantDe:
      "Erzaehl von etwas - aus Studium, Ausbildung, Ehrenamt, einem Hobby oder zu Hause -, bei dem du die Zeit vergessen hast. Was hast du dabei getan?",
  ...
  { key: "solved_problem", stage: "experience_episodes", yields: ["experience_episode", "action", "result"],
    ...
    followUpDe: "Welche Schritte hast du dabei gewaehlt, und warum gerade diese?",
  ...
  { key: "concrete_result", stage: "experience_episodes", yields: ["result"],
    ...
    followUpDe: "Laesst sich das irgendwie beziffern oder zeigen - auch grob?",
  ...
  { key: "asked_for_help", stage: "feedback_and_recognition", yields: ["skill"],
    de: "Wobei bitten dich andere regelmaessig um Hilfe?",
  ...
  { key: "easy_for_you", stage: "feedback_and_recognition", yields: ["skill"],
    de: "Welche Taetigkeit faellt dir leicht, die andere haeufig schwierig finden?",
  ...
  { key: "structure_vs_building", stage: "work_style_and_environment", yields: ["work_environment"],
    de: "Bevorzugst du klare Ablaeufe oder moechtest du lieber etwas Neues aufbauen?",
  ...
  { key: "shifting_priorities", stage: "work_style_and_environment", yields: ["skill", "work_environment"],
    de: "Wie gehst du mit kurzfristig wechselnden Prioritaeten um? Nenn mir bitte ein Beispiel.",
  ...
  { key: "responsibility_wanted", stage: "values_and_motives", yields: ["motive"],
    de: "Welche fachliche, Projekt- oder Personalverantwortung moechtest du uebernehmen?",
  ...
  { key: "value_ranking", stage: "values_and_motives", yields: ["motive"],
    de: "Ordne bitte nach Bedeutung: Gehalt, Sicherheit, Lernen, Autonomie, Sinn, Status, Flexibilitaet, Team.",
  ...
  { key: "non_negotiables", stage: "hard_constraints", yields: ["constraint"],
    de: "Welche drei Bedingungen sind fuer deinen naechsten Job nicht verhandelbar?",
  ...
  { key: "salary_tradeoffs", stage: "hard_constraints", yields: ["constraint", "preference"],
    de: "Welche anderen Bedingungen koennten einen niedrigeren Betrag ausnahmsweise ausgleichen?",
  ...
  { key: "location_options", stage: "location_and_logistics", yields: ["constraint"],
    de: "Welche Standorte, Pendelzeiten, Remote-Anteile, Reise- und Schichtmodelle sind fuer dich moeglich?",
  ...
  { key: "current_targets", stage: "learning_goals", yields: ["role", "preference"],
    de: "Welche Jobtitel oder Taetigkeitsfelder interessieren dich momentan?",
  ...
  { key: "excluded_roles", stage: "learning_goals", yields: ["constraint"],
    de: "Welche Rollen oder Branchen schliesst du ausdruecklich aus?",
    en: "Which roles or industries do you explicitly rule out?" },
  { key: "learning_goal_year", stage: "learning_goals", yields: ["motive"],
    de: "Was moechtest du in den naechsten zwoelf Monaten gelernt oder nachweisbar verbessert haben?",
...
/** Verstaendliche Themennamen fuer die Fortschrittsanzeige. */
export const STAGE_LABELS: Record<string, { de: string; en: string }> = {
  ...
  user_confirmation: { de: "Deine Bestaetigung", en: "Your confirmation" },
